 ...
 *
 * @param {string} [basePath] - Base path for the query (must start with `/` when provided).
 * @returns {Readonly<QueryBuilder>} - Frozen immutable query builder.
 * @throws {TypeError} When basePath is provided but is not a string starting with `/`.
 */
