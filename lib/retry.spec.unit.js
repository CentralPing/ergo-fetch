...
describe('createRetryInterceptor', () => {
  describe('factory validation', () => {
    ...
    it('returns an object with request and response', () => {
      const interceptor = createRetryInterceptor();
  ...
  describe('retry eligibility — idempotent-only statuses', () => {
    ...
    it('does not retry 502 for PUT without idempotent flag', () => {
    ...
    it('does not retry 504 for DELETE without idempotent flag', () => {
