...
describe('createQueryBuilder', () => {
  describe('factory validation', () => {
    ...
    it('throws TypeError when basePath is protocol-relative', () => {
      assert.throws(() => createQueryBuilder('//evil.example/articles'), {
        name: 'TypeError',
        message: /protocol-relative/
      });
    });

    it('throws TypeError when basePath contains a query string', () => {
    ...
    it('throws TypeError when basePath contains a fragment', () => {
