...
describe('createCsrfInterceptor', () => {
  describe('factory validation', () => {
    ...
    it('throws TypeError for headerName with spaces', () => {
      assert.throws(() => createCsrfInterceptor({headerName: 'bad header'}), {
        name: 'TypeError',
        message: 'headerName must be a valid HTTP token (RFC 9110 Section 5.6.2)'
      });
    });
    ...
    it('throws TypeError for headerName with colons', () => {
      assert.throws(() => createCsrfInterceptor({headerName: 'x:custom'}), {
        name: 'TypeError',
        message: 'headerName must be a valid HTTP token (RFC 9110 Section 5.6.2)'
      });
    });
    ...
    it('throws TypeError when options is a number', () => {
      assert.throws(() => createCsrfInterceptor(1), {
        name: 'TypeError',
    ...
    it('throws TypeError when options is a string', () => {
      assert.throws(() => createCsrfInterceptor('test'), {
        name: 'TypeError',
        message: 'options must be an object'
      });
    });
    ...
    it('throws TypeError when options is a boolean', () => {
      assert.throws(() => createCsrfInterceptor(true), {
        name: 'TypeError',
        message: 'options must be an object'
      });
    });
    ...
    it('throws TypeError when options is null', () => {
      assert.throws(() => createCsrfInterceptor(null), {
        name: 'TypeError',
        message: 'options must be an object'
      });
    });
    ...
    it('throws TypeError when options is an array', () => {
      assert.throws(() => createCsrfInterceptor([]), {
        name: 'TypeError',
        message: 'options must be an object'
      });
    });
